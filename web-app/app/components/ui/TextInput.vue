...
<template>
  <div class="flex flex-col">
    <input
      ...
      :type="props.type"
      :required
      class="w-full h-[42px]! border-2 rounded-2xl py-2 px-3 text-ovis-neutral-50! border-ovis-neutral-700 disabled:border-ovis-info-200 disabled:bg-ovis-info-50 disabled:text-ovis-info-500 disabled:shadow-none focus:border-ovis-neutral-600! outline-0 focus:border-2 focus:outline-0!"
      :class="[
        extraClasses,
        {
