...
<template>
  <button
    ...
    class="group relative flex items-center justify-center text-white w-full h-[42px]! text-nowrap py-0! px-5 rounded-xl font-semibold overflow-hidden hover:font-semibold active:font-semibold duration-300 transition-all ease-out active:scale-[1.01]"
  >
    <div
      v-if="!loading"
