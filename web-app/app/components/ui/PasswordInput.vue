...
<template>
    <div class="flex flex-col">
        <div class="flex flex-row group w-full h-[42px]! group group-focus">
            <input v-bind="$attrs" @keypress="handleType" :type="inputType" :required
                class="w-full py-2 px-3 border-2 border-r-2 border-ovis-neutral-700 text-ovis-neutral-50 disabled:border-ovis-info-200 disabled:bg-ovis-info-50 disabled:text-ovis-info-500 disabled:shadow-none
         group-focus-within:outline-none group-focus-within:border-ovis-neutral-600 group-focus-within:outline group-focus-within:border-2" :class="[
            extraClasses,
            props.type === 'password'
