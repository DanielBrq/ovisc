...
<template>
    <nav class="fixed top-0 right-0 h-12 z-40 transition-all duration-400" :class="[
        ...
        <div class="flex items-center justify-between w-full h-full bg-ovis-neutral-800 shadow-sm px-4 transition-all duration-400 border-b border-ovis-neutral-700"
            ...
            <NuxtLink :to="AppRoutes.home"
                ...
                <span
                    class="bg-linear-to-r from-ovis-primary-500 to-ovis-danger-500 bg-clip-text font-bold tracking-tight text-transparent 
