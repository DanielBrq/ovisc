...
<template>
    <!-- Overlay -->
    <div v-if="visible" @click="visible = false"
    ...
    <div
        ...
        <!-- Header -->
        <div class="flex items-center justify-between p-4 border-b border-ovis-neutral-800">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-4 flex flex-col gap-2">
            ...
            <div class="border-b border-ovis-neutral-800/50 pb-2">
                <button @click="toggleFilter('OrderBy')"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-medium text-ovis-neutral-200 group-hover:text-ovis-neutral-50 transition-colors">
                            Ordenar por
                        </span>
                    </div>
            ...
            <div class="border-b border-ovis-neutral-800/50 pb-2">
                ...
                <div class="overflow-hidden transition-all duration-300 ease-in-out"
                    ...
                    <div class="px-3">
                        <p class="text-ovis-neutral-400 text-sm italic">Selector de precio...</p>
                    </div>
                </div>
            </div>
            ...
            <div class="pb-2">
                ...
                <div class="overflow-hidden transition-all duration-300 ease-in-out"
                    ...
                    <div class="px-3">
                        <p class="text-ovis-neutral-400 text-sm italic">Estrellas de calificaciÃ³n...</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Action Buttons -->
        <div class="p-4 border-t border-ovis-neutral-800 bg-ovis-neutral-900/50 backdrop-blur-sm">
